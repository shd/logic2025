...
\item Наш интерес сегодня --- интерпретации на многих мирах (Сол Крипке), где
...
\begin{frame}{Недетерминированные (обобщённые) автоматы Бюхи}
\begin{dfn}
...
Бесконечная строка $\alpha = a_0a_1a_2\dots$ допускается недетерминированным (обобщённым) автоматом Бюхи, 
...
\begin{frame}{Пример обобщённого недетерминированного автомата Бюхи}
\begin{exm}
...
наличие момента активации в будущем).
\end{itemize}
\end{frame}
...
\item построим их пересечение --- и преобразуем автомат в недетерминированный автомат Бюхи $T$
