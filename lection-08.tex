...
\item Частноотрицательное предложение --- неверно общеутвердительное.
...
\begin{dfn}
Будем говорить, что отношение $R\subseteq \mathbb{N}^n_0$ выразимо в Ф.А., 
...
взаимно просты, и $0 \le a_i < u_i$, то существует такое $b$, что $a_i = b \% u_i$.
\end{thm}\pause
