...
\item Если исключить из ЛТЛ формулы с $\mathcal{U}$ и $\bigcirc$, верно ли, что
все оставшиеся формулы (то есть, формулы с $\Diamond$ и $\Box$) доказываются в S5?
...
что каждая фаза длится 5 условных тактов, и 1 такт длится фаза жёлтого сигнала
(цикл примем таким: красный --- жёлтый --- зелёный --- красный).
